/* ==========================================================================
   Albertini Tuning — clickjacking protection.
...
(function () {
  ...
  try {
    ...
    var show = function () {
      ...
      el.style.cssText = 'position:fixed;inset:0;z-index:2147483647;background:#0A0B0D;' +
      ...
      a.href = 'https://oriantoledano-ship-it.github.io/albertini-tuning/';
      a.target = '_top';
      a.rel = 'noopener';
      a.style.cssText = 'color:#245BFF;font-weight:700';
      a.textContent = 'מעבר לאתר הרשמי של Albertini Tuning';
      inner.appendChild(p);
      inner.appendChild(a);
